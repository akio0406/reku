...
@app.on_message(filters.command("removeurl") & filters.create(lambda _, __, m: check_user_access(m.from_user.id)))
...
@app.on_message(filters.command("dice") & filters.create(lambda _, __, m: check_user_access(m.from_user.id)))
...
@app.on_message(filters.command("merge") & filters.create(lambda _, __, m: check_user_access(m.from_user.id)))
